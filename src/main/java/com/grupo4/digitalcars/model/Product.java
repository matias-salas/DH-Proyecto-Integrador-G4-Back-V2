...
public class Product {
   ...
   /* public Product(Integer id, String name, String description, String short_description, boolean active, String address, String latitude, String longitude, String area, Double average_score, Transmission transmission, Category category) {
        this.id = id;
        this.name = name;
    ...
    /*public Product(Integer id, String name, String description, String short_description, boolean active, String address, String latitude, String longitude, String area, Double average_score, Transmission transmission, Category category, String policiesSite, String policiesSecurityAndHealth, String policiesCancellation) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.short_description = short_description;
